...
- **项目状态**：已完成全文本 AI 翻译，后续将由悦子yuezi对全文本组织人工校对。如有意向加入校对组或发现文本错误，请联系邮箱：wty13208@163.com。如遇补丁程序问题，如卡死，黑屏等，请联系邮箱：zeratalsky@gmail.com或直接在GitHub中提交issue，并附上错误截图

---

## 🎮 玩家安装说明
若您仅需安装已发布的汉化补丁：
0. **下载补丁**：点击右侧Releases条目下最新版本的补丁链接，跳转后点击app.asar下载补丁
